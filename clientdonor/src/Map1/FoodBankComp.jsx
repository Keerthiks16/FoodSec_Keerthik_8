...
const cityCoordinates = {
  ...
  Nagpur: [21.1458, 79.109],
  Lucknow: [26.8468, 80.9462],
  Visakhapatnam: [17.6868, 83.2185],
  Bhopal: [23.2599, 77.4126],
  Patna: [25.5941, 85.1376],
  Vadodara: [22.3098, 73.188],
...
const MapComponent = () => {
  ...
  const filteredFoodBanks = foodBankData.features.filter(
    (foodBank) =>
      foodBank.properties.City.toLowerCase() === selectedCity.toLowerCase()
  );
        ...
        {selectedFoodBank && (
          ...
          >
            ...
            <p>
              ...
              {selectedFoodBank.properties.Description}
            </p>
          </div>
        )}
      </div>
