        ...
        <div className="contain flex items-center justify-center space-x-8 relative z-10">
          <div className="container bg-white p-8 rounded-lg shadow-lg max-w-lg text-center">
            ...
            <h2 className="text-2xl text-gray-700 mb-4">
              Empower Communities & Support Causes
            </h2>
            <p className="text-gray-600 text-lg mb-6">
              Join us in making a difference. Through your donations, you can
              help create a better world by supporting those in need. Contribute
              now or fill out the form to become part of our donation
              initiatives.
            </p>
            <Link to={"/donateNow"}>
          ...
          <div className="container bg-white p-8 rounded-lg shadow-lg max-w-lg text-center">
            ...
            <h2 className="text-2xl text-gray-700 mb-4">
              Contribute & Help Change Lives
            </h2>
            <p className="text-gray-600 text-lg mb-6">
              Your contribution is more than just a donation – it is a lifeline
              for those in need. By supporting causes, you are helping bring
              hope and joy to communities. Get involved, fill out the form, or
