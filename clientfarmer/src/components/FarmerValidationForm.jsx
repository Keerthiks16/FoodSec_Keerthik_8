...
const FarmerValidationForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.farmerId.match(/^FID\d{6}$/)) {
      newErrors.farmerId = 'Farmer ID should be in format FID followed by 6 digits';
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {submitStatus === 'error' && (
              <div className="flex items-center space-x-2 p-4 bg-red-100 border border-red-500 rounded">
                ...
                <p className="text-red-600">Please correct the errors in the form.</p>
              </div>
            )}

            {/* Submit Button */}
            <div className="bg-gray-50 px-6 py-4 -mx-6 -mb-6">
              <button
                type="submit"
